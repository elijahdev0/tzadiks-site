...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-oneshot-dark text-white" dir="rtl">
      <Helmet>
        <title>משיכת פיקדון צבאי - הדרך המהירה והבטוחה | One Shot</title>
        <meta name="description" content="חיילים משוחררים? גלו איך למשוך את הפיקדון הצבאי מוקדם ולהשתמש בו לרכישת נשק והוצאת רישיון נשק בישראל במהירות ובקלות." />
        <meta name="keywords" content="משיכת פיקדון צבאי, רישיון נשק לחיילים משוחררים, אישור נשק לאחר הצבא, חוקי נשק לחיילים משוחררים" />
      </Helmet>
      ...
      <div className="py-16 bg-oneshot-gray">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-6 text-oneshot-gold">
            משיכת פיקדון צבאי - הדרך המהירה והבטוחה
          </h1>
          <p className="text-xl md:text-2xl max-w-2xl mx-auto">
            איך למשוך את הפיקדון הצבאי מוקדם ולהשתמש בו לטובתך?
          </p>
        </div>
      </div>
              ...
              <div className="relative p-8">
                ...
                <div className="mt-12">
                  <h2 className="text-3xl font-bold text-oneshot-gold mb-4">
                    רישיון נשק בישראל - מדריך מלא
                  </h2>
                  <p className="mb-6 text-oneshot-light">
                    איך לקבל רישיון נשק מהר? אנחנו מקצרים לך את הדרך - עד 14 ימי עסקים בלבד!
                  </p>
          ...
          >
            <div className="bg-oneshot-gray rounded-2xl overflow-hidden shadow-2xl border border-oneshot-gold/20">
              <div className="relative p-8">
                ...
                <div className="mt-12">
                  <h2 className="text-3xl font-bold text-oneshot-gold mb-4">
                    משיכת פיקדון לרכישת נשק – כל מה שצריך לדעת
                  </h2>
                  <p className="mb-6 text-oneshot-light">
            ...
            <div className="bg-oneshot-dark/70 p-8 rounded-xl shadow-lg mt-12 border border-oneshot-gold/20">
              <h3 className="text-2xl font-bold text-oneshot-gold mb-4 text-center">
                חוקי נשק לחיילים משוחררים – מה מותר ומה אסור?
              </h3>
            ...
            {/* FAQ Section */}
            <div className="mt-12">
              <h3 className="text-2xl font-bold text-oneshot-gold mb-6 text-center">
                שאלות נפוצות על משיכת פיקדון צבאי
              </h3>
              <div className="space-y-6">
                <div className="bg-oneshot-gray/50 p-6 rounded-lg">
                  <h4 className="text-xl font-bold text-oneshot-gold mb-2">איך ניתן לבצע משיכת פיקדון לרכישת נשק?</h4>
                  <p>אנחנו מלווים אותך בכל התהליך - מהגשת הבקשה למשיכת הפיקדון ועד לקבלת רישיון הנשק.</p>
                </div>
                <div className="bg-oneshot-gray/50 p-6 rounded-lg">
                  <h4 className="text-xl font-bold text-oneshot-gold mb-2">מהם התנאים לקבלת רישיון נשק בישראל?</h4>
                  <p>התנאים כוללים גיל מינימום, שירות צבאי, עבר נקי, ועמידה בקריטריונים נוספים שנקבעו בחוק.</p>
                </div>
                <div className="bg-oneshot-gray/50 p-6 rounded-lg">
                  <h4 className="text-xl font-bold text-oneshot-gold mb-2">איך אפשר לקבל רישיון נשק מהר?</h4>
                  <p>אנחנו מציעים מסלול מזורז עם ליווי מקצועי, המאפשר קבלת רישיון עד 14 ימי עסקים.</p>
                </div>
                <div className="bg-oneshot-gray/50 p-6 rounded-lg">
                  <h4 className="text-xl font-bold text-oneshot-gold mb-2">האם יש קורס חובה לפני קבלת הרישיון?</h4>
                  <p>כן, קורס נשק הוא חובה. אנחנו מלווים אותך גם בתהליך ההכנה לקורס.</p>
                </div>
              </div>
            </div>
          </motion.div>
